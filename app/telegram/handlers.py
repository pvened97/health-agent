...
async def handle_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    onboarding_prompt = (
        ...
        "Тебе нужно узнать: пол, возраст, рост, вес, цель "
        "(набор массы, похудение, поддержание формы, рекомпозиция) "
        "и уровень бытовой активности (сидячая работа, активная, физический труд и т.д.). "
        "Калории и белок спрашивать НЕ нужно — они будут рассчитаны автоматически. "
